...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MsorLi.Utilities.CheckableFab, MsorLi.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", CheckableFab.class, __md_methods);
	}
	...
	public CheckableFab (android.content.Context p0)
	{
		...
		if (getClass () == CheckableFab.class)
			mono.android.TypeManager.Activate ("MsorLi.Utilities.CheckableFab, MsorLi.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
